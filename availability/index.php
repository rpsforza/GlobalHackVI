	...
	<div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
		<header class="demo-header mdl-layout__header mdl-color--grey-100 mdl-color-text--grey-600">
			<div class="mdl-layout__header-row">
				<span class="mdl-layout-title">Availabifalse</span>
		...
		<div class="demo-drawer mdl-layout__drawer mdl-color--blue-grey-900 mdl-color-text--blue-grey-50">
			...
			switch ($userType) { // [alt text, mdl font icon, current page]
				...
				case "client":
					...
					break;
				case "coc":
					$a = [["dash", "dashboard", false], ["map", "map", false], ["profile", "account_box", false], ["shelter", "hotel", false], ["housing", "home", false], ["services", "domain", false], ["availability", "people", true], ["statistics", "timeline", false]];
					break;
				case "host":
					$a = [["dash", "dashboard", false], ["map", "map", false], ["profile", "account_box", false], ["shelter", "hotel", false], ["availability", "people", true]];
					break;
				default:
					$a = [["dash", "dashboard", false], ["map", "map", false], ["shelter", "hotel", false], ["housing", "home", false], ["services", "domain", false]];
					break;
