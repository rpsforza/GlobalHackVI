		...
		<div class="demo-drawer mdl-layout__drawer mdl-color--blue-grey-900 mdl-color-text--blue-grey-50">
			...
			switch ($userType) { // [alt text, mdl font icon, current page]
				case "clientNoAuth":
					...
					break;
				case "client":
					$a = [["dash", "dashboard", false], ["profile", "account_box", true], ["map", "map", false], ["shelter", "hotel", false], ["services", "domain", false], ["housing", "home", false]];
					break;
				case "coc":
					$a = [["dash", "dashboard", false], ["profile", "account_box", true], ["map", "map", false], ["shelter", "hotel", false], ["services", "domain", false], ["housing", "home", false], ["availability", "people", false], ["statistics", "timeline", false]];
					break;
				case "host":
					$a = [["dash", "dashboard", false], ["profile", "account_box", true], ["map", "map", false], ["shelter", "hotel", false], ["availability", "people", false]];
					break;
				default:
					$a = [["dash", "dashboard", false], ["map", "map", false], ["shelter", "hotel", false], ["services", "domain", false], ["housing", "home", false]];
					break;
