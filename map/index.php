	...
	<div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
		...
		<div class="demo-drawer mdl-layout__drawer mdl-color--blue-grey-900 mdl-color-text--blue-grey-50">
			...
			switch ($userType) { // [alt text, mdl font icon, current page]
				case "clientNoAuth":
					$a = [["dash", "dashboard", false], ["map", "map", true], ["shelter", "hotel", false], ["housing", "home", false], ["services", "domain", false]];
					break;
				case "client":
					$a = [["dash", "dashboard", false], ["map", "map", true], ["profile", "account_box", false], ["shelter", "hotel", false], ["housing", "home", false], ["services", "domain", false]];
					break;
				case "coc":
					$a = [["dash", "dashboard", false], ["map", "map", true], ["profile", "account_box", false], ["shelter", "hotel", false], ["housing", "home", false], ["services", "domain", false], ["availability", "people", false], ["statistics", "timeline", false]];
					break;
				case "host":
					$a = [["dash", "dashboard", false], ["map", "map", true], ["profile", "account_box", false], ["shelter", "hotel", false], ["availability", "people", false]];
					break;
				default:
					$a = [["dash", "dashboard", false], ["map", "map", true], ["shelter", "hotel", false], ["housing", "home", false], ["services", "domain", false]];
					break;
